  ...
  const createForecastCard = (each) => {
    const forecast = `<div
            ...
            <div class="card-body">
                ...
                <p class="card-text text-center">Temp : ${
                  each.temp.day
                } <span>&#8451;</span></p>
                <p class="card-text text-center">Humidity : ${
                  each.humidity
                }%</p>
                <p class="card-text text-center">Wind Speed : ${
                  each.wind_speed
                } MPH</p>
                <p class="card-text text-center">
                UV Index:
...
const handleFormSubmit = async (event) => {
  ...
  const lowercaseLetters = cityName.toLowerCase();
  ...
  if (cityName) {
    ...
    if (!recentSearches.includes(lowercaseLetters) && renderStatus) {
      // push city name to array
      recentSearches.push(lowercaseLetters);
